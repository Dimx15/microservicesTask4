package com.spring.rest.template.microservicestask4.services;

import com.spring.rest.template.microservicestask4.model.User;
...
public class UserServiceImpl {
    ...
    public String getAnswer() { //вызывает три других метода (addUser(), updateUser(), deleteUser()) и возвращает конкатенированные ответы от сервера.
